...
const MyFavorite = () => {
  ...
  return (
    <div className="px-4">
      <h1 className="text-center text-3xl font-bold py-8 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-rose-500 to-pink-500">Favorites</h1>
      <div className="overflow-x-auto">
        <Table hoverable>
          ...
          <Table.Body className="divide-y">
            {allFavorite?.map((fav) => (
             fav.email === user?.email ?  <Table.Row
             key={fav._id}
